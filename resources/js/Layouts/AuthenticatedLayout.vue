...
import {
    ...
    darkTheme,
    NInput,
    NButton, NNotificationProvider, NDialogProvider,
} from "naive-ui";
                ...
                <n-layout has-sider>
                    ...
                    >
                            ...
                            <template v-for="item in links">
                                ...
                                >
                                    <j-icon
                                        ...
                                        classes="transition-all" :size="32"/>
                                    <span
                                        :class="{
                        ...
                        <div class="text-center">
                            <j-icon name="material-symbols-light:security" classes="transition-all text-olive-900" :size="32"/>
                            <span>Admin</span>
                        </div>
                    </n-layout-sider>
                            ...
                            >
                                ...
                                <div class="flex flex-row space-x-2 items-center">
                                    <n-button circle quaternary>
                                        <template #icon
                                        >
                                            <j-icon name="material-symbols-light:notifications-outline"/>
                                        </template>
                                    </n-button>
